...
\pagestyle{head}
\firstpageheader{\textbf{\class\ - \term}}{\textbf{\examnum}}{\textbf{Due: Feb. 22\\ beginning of class}}
\runningheader{\textbf{\class\ - \term}}{\textbf{\examnum}}{\textbf{Due: Feb. 22\\ beginning of class}}
\runningheadrule

\newcommand{\class}{Econ 5253}
\newcommand{\term}{Spring 2022}
\newcommand{\examdate}{Due: February 22, 2022}
...
\begin{parts}
    \part Download the following file from within R, Python, or Julia: \url{"https://www.vizgr.org/historical-events/search.php?format=json&begin_date=00000101&end_date=20220219&lang=en"}
